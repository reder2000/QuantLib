...
namespace QuantLib {
    ...
    */
    template <class Date>
    class UnitedStates : public Calendar<Date> {
      private:
        ...
        class NyseImpl : public Calendar<Date>::WesternImpl {
          public:
            std::string name() const { return "New York stock exchange"; }
            bool isBusinessDay(const Date&) const;
        };
        class GovernmentBondImpl : public Calendar<Date>::WesternImpl {
          public:
            std::string name() const { return "US government bond market"; }
            bool isBusinessDay(const Date&) const;
        };
        class NercImpl : public Calendar<Date>::WesternImpl {
          public:
            std::string name() const { return "North American Energy Reliability Council"; }
            bool isBusinessDay(const Date&) const;
        };
        class FederalReserveImpl : public Calendar<Date>::WesternImpl {
          public:
      ...
      public:
        ...
        bool isWashingtonBirthday(Day d, Month m, Year y, Weekday w) {
            if (y >= 1971) {
                ...
                return (d == 22 || (d == 23 && w == Monday) || (d == 21 && w == Friday)) &&
                       m == February;
            }
        }
        ...
        bool isMemorialDay(Day d, Month m, Year y, Weekday w) {
            if (y >= 1971) {
                ...
                return (d == 30 || (d == 31 && w == Monday) || (d == 29 && w == Friday)) &&
                       m == May;
            }
        }
        ...
        bool isVeteransDay(Day d, Month m, Year y, Weekday w) {
            if (y <= 1970 || y >= 1978) {
                ...
                return (d == 11 || (d == 12 && w == Monday) || (d == 10 && w == Friday)) &&
                       m == November;
            } else {
